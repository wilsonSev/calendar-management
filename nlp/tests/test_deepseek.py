"""Tests for deepseek_api.parse_message function"""
import sys
import os
...
from deepseek_api import parse_message
...
class TestParseMessageSuccess:
    ...
    @patch("deepseek_api._get_client")
    ...
    @patch("deepseek_api._get_client")
    def test_correct_model_used(self, mock_get_client):
...
class TestParseMessageErrors:
    ...
    @patch("deepseek_api.DEEPSEEK_API_KEY", None)
