"""Tests for corebras.parse_message function"""
import sys
import os
...
from corebras import parse_message
...
class TestParseMessageSuccess:
    ...
    @patch("corebras._get_client")
    def test_correct_model_and_params(self, mock_get_client):
...
class TestParseMessageErrors:
    ...
    @patch("corebras.CEREBRAS_API_KEY", None)
