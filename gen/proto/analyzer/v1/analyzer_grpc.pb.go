...
const (
	AnalyzerService_AnalyzeText_FullMethodName = "/analyzer.v1.AnalyzerService/AnalyzeText"
)
...
func (c *analyzerServiceClient) AnalyzeText(ctx context.Context, in *AnalyzeTextRequest, opts ...grpc.CallOption) (*AnalyzeTextResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(AnalyzeTextResponse)
	err := c.cc.Invoke(ctx, AnalyzerService_AnalyzeText_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedAnalyzerServiceServer) AnalyzeText(context.Context, *AnalyzeTextRequest) (*AnalyzeTextResponse, error) {
...
func _AnalyzerService_AnalyzeText_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(AnalyzeTextRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AnalyzerServiceServer).AnalyzeText(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AnalyzerService_AnalyzeText_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AnalyzerServiceServer).AnalyzeText(ctx, req.(*AnalyzeTextRequest))
	}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _AnalyzerService_AnalyzeText_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "proto/analyzer/v1/analyzer.proto",
}
